...
import style from './AstronautasForm.module.css';

function reg(){
    Swal.fire({
    title: "Šaunuolis!!!",
    text: "Baigta sėkmingai!!!",
    icon: "success"
          
          });
       }

export function AstronautasForm() {
    ...
    return (
        <form onSubmit={handleFormSubmit} className={style.form}>
            ...
            <div className={style.formRow}>
                <button onClick={reg()} className={style.button} type="submit">Register</button>
            </div>
        </form>
    );
}
